...
* @param: const DCircularList<T> &_other
*-----------------------------------------------------*/
...
*
* Copy constructor
* @param:const DCircularList<T> &_other cannot be changed
*-----------------------------------------------------*/
template <class T>
 ...
 * @param:<template> T in this project, T is Student
 * ----------------------------------------------------*/
template <class T>
...
* @param: T <template> in this project, T is Student
* ----------------------------------------------------*/
template <class T>
