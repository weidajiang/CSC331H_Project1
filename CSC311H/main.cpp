...
int main(){
    ...
    // test = operator;
//    Student *_newStudent1= new Student("weida","1234");
//    Student *_newStudent2= new Student("jiang","4321");
//    _studentList.push_front(*_newStudent1);
//    _studentList.push_front(*_newStudent2);
//
//    DCircularList<Student> _studentList2;
//    _studentList2=_studentList;
//    printForward(_studentList2);
//    
//    // test copy constructor
//    DCircularList<Student> _studentList3(_studentList);
//    printForward(_studentList3);
//    _studentList.clear();
//    _studentList2.clear();
//    _studentList3.clear();
//    
...
void printMenus(){
    ...
    std::cout<<"**\t\t\t\t  6.Search Student information by student ID     \t\t**"<<std::endl;
